...
| 第18次课程     | 常见的NPC问题，定义8.34，8.35，8.36，8.37                    | 第7章3                    | 电子中文书第8章8.5                                      | 学生：张新明         |
...
| 第20次课程     | Space Complexity：<br />（1）8.3 PSPACE completeness：Winning strategies for games.  example 8.10 and theorem 8.11; Generalized Geography-theorem 8.14<br />（2）space complexity summary: summarize the classed of space complexity, summarize section 8.4 and 8.5   空间复杂度：总结下空间复杂度的分类，中文电子书中的定义9.11 简单回顾下证明，分析总结9.4 | 题目：                    | 中文第9章9.3后半部分+9.4，chapter 8 in English book 8.3 |                      |
