...
|               | 4. P问题定义和举例  （中文书7.2.2，定理7.12，7.13）<br /><img src="C:\Users\duan\AppData\Roaming\Typora\typora-user-images\image-20211103165053184.png" alt="image-20211103165053184" style="zoom:67%;" /><br />5. NP问题定义：Nondeterministic Complexity，确定性TM 多项式时间可验证。。。(中文书，定义7.16,定理7.17-推论7.19)<br />6.典型的NP类问题 (HAMPATH and COMPOSITES∈ NP) |                            |                                                         | 刘海壮 |          |
